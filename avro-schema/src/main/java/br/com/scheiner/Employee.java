...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6662469595686958001L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"br.com.scheiner\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"},{\"name\":\"document\",\"type\":\"string\"}]}");
   ...
   */
  public Employee(java.lang.CharSequence name, java.lang.CharSequence lastName, java.lang.CharSequence document) {
    this.name = name;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: document = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static br.com.scheiner.Employee.Builder newBuilder() {
    return new br.com.scheiner.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static br.com.scheiner.Employee.Builder newBuilder(br.com.scheiner.Employee.Builder other) {
    if (other == null) {
      return new br.com.scheiner.Employee.Builder();
    } else {
      return new br.com.scheiner.Employee.Builder(other);
    }
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static br.com.scheiner.Employee.Builder newBuilder(br.com.scheiner.Employee other) {
    if (other == null) {
      return new br.com.scheiner.Employee.Builder();
    } else {
      return new br.com.scheiner.Employee.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.scheiner.Employee.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[2], other.document)) {
        this.document = data().deepCopy(fields()[2].schema(), other.document);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.scheiner.Employee other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder setDocument(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.scheiner.Employee.Builder clearDocument() {
      document = null;
    ...
    public Employee build() {
      try {
        ...
        record.document = fieldSetFlags()[2] ? this.document : (java.lang.CharSequence) defaultValue(fields()[2]);
        return record;
